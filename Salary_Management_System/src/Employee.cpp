...
Employee::Employee(const std::string& id, const std::string& name,
                   ...
                   const std::string& position,double basicSalary, const std::string& password)
...
bool Employee::getHasAdminAccess() const    { return hasAdminAccess; }
SalaryStructure Employee::getSalary() const { return salary; }
int Employee::getLeavesTaken() const        { return salary.getLeavesTaken(); }
double Employee::getBasicSalary() const     { return salary.getBasicSalary(); }

void Employee::setName(const std::string& n)        { name = n; }
void Employee::setDob(const std::string& d)         { dob = d; }
void Employee::setEmail(const std::string& e)       { email = e; }
void Employee::setPhone(const std::string& p)       { phone = p; }
void Employee::setDepartment(const std::string& d)  { department = d; }
void Employee::setPosition(const std::string& p)    { position = p; }
void Employee::setPassword(const std::string& p)    { password = p; }
