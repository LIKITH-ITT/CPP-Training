...
Simulation::Simulation(Intersection* intersection) : intersection_(intersection), ui_(nullptr), query_(intersection), running_(false), stopped_(false)
{}
...
void Simulation::runQueryLoop()
{
    ...
    while (running_ && keepGoing && std::cin.good())
    {
